...
#include "MarkdownContentBrowserFolderItemDataPayload.h"
#include "MarkdownContentBrowserDataSource.generated.h"
#define UE_TRY_GET_COLLECTION_ID_F_SOFT_OBJECT_PATH 0
#define UE_F_TOP_LEVEL_ASSET_PATH 0
USTRUCT()
struct FMarkdownContentBrowserDataFilter
{
	GENERATED_BODY()
...
UCLASS()
class UMarkdownContentBrowserDataSource : public UContentBrowserDataSource
{
	GENERATED_BODY()
...
private:
	...
	TSharedPtr<const FMarkdownContentBrowserFolderItemDataPayload> GetFolderItemDataPayload(
		const FContentBrowserItemData& InItemData) const;
...
private:
	...
	TSharedPtr<FMarkdownContentBrowserHierarchy> MarkdownHierarchy;
